...
use windows::Win32::Foundation::{SEC_E_MESSAGE_ALTERED, SEC_E_OK, SEC_E_OUT_OF_SEQUENCE};
use windows::Win32::Foundation::{SEC_I_CONTEXT_EXPIRED, SEC_I_MESSAGE_FRAGMENT, SEC_I_RENEGOTIATE};
use windows::Win32::Security::Authentication::Identity::{AcceptSecurityContext, AcquireCredentialsHandleW};
use windows::Win32::Security::Authentication::Identity::{DecryptMessage, DeleteSecurityContext};
use windows::Win32::Security::Authentication::Identity::{EncryptMessage, FreeContextBuffer};
use windows::Win32::Security::Authentication::Identity::{FreeCredentialsHandle, InitializeSecurityContextW};
use windows::Win32::Security::Authentication::Identity::{QueryContextAttributesExW, QueryContextAttributesW};
use windows::Win32::Security::Authentication::Identity::{SecBuffer, SecBufferDesc};
...
use windows::Win32::Security::Authentication::Identity::{SecPkgContext_StreamSizes, SetContextAttributesW};
use windows::Win32::Security::Authentication::Identity::{ASC_REQ_CONFIDENTIALITY, ASC_REQ_DATAGRAM};
use windows::Win32::Security::Authentication::Identity::{ASC_REQ_EXTENDED_ERROR, ASC_REQ_INTEGRITY};
use windows::Win32::Security::Authentication::Identity::{ASC_REQ_MUTUAL_AUTH, ISC_REQ_CONFIDENTIALITY};
use windows::Win32::Security::Authentication::Identity::{ISC_REQ_DATAGRAM, ISC_REQ_EXTENDED_ERROR};
use windows::Win32::Security::Authentication::Identity::{ISC_REQ_INTEGRITY, ISC_REQ_MANUAL_CRED_VALIDATION};
use windows::Win32::Security::Authentication::Identity::{ISC_REQ_USE_SUPPLIED_CREDS, SCH_CREDENTIALS};
use windows::Win32::Security::Authentication::Identity::SCH_CREDENTIALS_VERSION;
use windows::Win32::Security::Authentication::Identity::{SCH_CRED_FORMAT_CERT_CONTEXT, SCH_USE_DTLS_ONLY};
use windows::Win32::Security::Authentication::Identity::{SECBUFFER_ALERT, SECBUFFER_DATA};
use windows::Win32::Security::Authentication::Identity::{SECBUFFER_DTLS_MTU, SECBUFFER_EMPTY};
...
use windows::Win32::Security::Authentication::Identity::{SECBUFFER_STREAM_TRAILER, SECBUFFER_TOKEN};
use windows::Win32::Security::Authentication::Identity::{SECBUFFER_VERSION, SECPKG_ATTR};
...
use windows::Win32::Security::Authentication::Identity::{SECPKG_ATTR_STREAM_SIZES, SECPKG_CRED_INBOUND};
use windows::Win32::Security::Authentication::Identity::{SECPKG_CRED_OUTBOUND, SECURITY_NATIVE_DREP};
use windows::Win32::Security::Authentication::Identity::{SEC_DTLS_MTU, UNISP_NAME_W};
