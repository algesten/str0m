...
/// RFC 6298: EWMA smoothing factor for RTT (alpha = 1/8)
...
pub struct DelayController {
    ...
    /// Replaces the previous mean_max_rtt calculation for more accurate RTT estimation
    /// matching WebRTC's approach.
...
impl DelayController {
    ...
    ///
    /// This matches WebRTC's approach of each controller maintaining its own smoothed RTT
    /// rather than relying on feedback-provided RTT values.
