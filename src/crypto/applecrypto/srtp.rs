...
use str0m_applecrypto::{srtp_aead_aes_gcm_decrypt, srtp_aead_aes_gcm_encrypt};
use str0m_applecrypto::{srtp_aes_128_cm, srtp_aes_ecb_round, SrtpKey};

pub struct AppleCryptoSrtpCryptoImpl;

impl SrtpCryptoImpl for AppleCryptoSrtpCryptoImpl {
    type Aes128CmSha1_80 = AppleCryptoAes128CmSha1_80;
    type AeadAes128Gcm = AppleCryptoAeadAes128Gcm;
    type AeadAes256Gcm = AppleCryptoAeadAes256Gcm;
...
pub struct AppleCryptoAes128CmSha1_80 {
    key: SrtpKey,
}

impl aes_128_cm_sha1_80::CipherCtx for AppleCryptoAes128CmSha1_80 {
...
pub struct AppleCryptoAeadAes128Gcm {
    key: SrtpKey,
}

impl aead_aes_128_gcm::CipherCtx for AppleCryptoAeadAes128Gcm {
...
pub struct AppleCryptoAeadAes256Gcm {
    key: SrtpKey,
}

impl aead_aes_256_gcm::CipherCtx for AppleCryptoAeadAes256Gcm {
    /// Create a new context for AES-256-GCM encryption/decryption.
    ///
    /// The encrypt flag is ignored, since it is not needed and the same
    /// key can be used for both encryption and decryption.
